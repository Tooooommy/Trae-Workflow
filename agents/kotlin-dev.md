---
name: kotlin-dev
description: Kotlin/Android 开发专家。负责 Kotlin/Android 原生移动应用开发、代码审查、构建修复、协程安全、最佳实践。在 Kotlin/Android 项目中使用。
mcp_servers:
  - memory
  - sequential-thinking
  - context7
...
| 技能            | 用途                    |
| --------------- | ----------------------- |
| kotlin-patterns | Kotlin/Android 模式     |
| android-native-patterns| Android 原生模式 |
| tdd-workflow    | TDD 工作流              |

## 相关规则目录

- `project_rules/kotlin/` - Kotlin/Android 特定规则
