---
name: ux-engineer
description: 设计专家模式。负责交互设计、视觉设计、品牌视觉、设计系统。优先由 orchestrator-expert 调度激活。
---
...
**优先由 orchestrator-expert 调度激活**（阶段2：产品定义，与 product-strategist 协同）
...
| 文档     | 路径                               | 模板                      |
| -------- | ---------------------------------- | ------------------------- |
| 设计稿   | docs/02-design/ui-design-\*.md     | ui-design-template.md     |
| 交互规范 | docs/02-design/interaction-\*.md   | interaction-template.md   |
| 设计系统 | docs/02-design/design-system-\*.md | design-system-template.md |

### 模板文件

位置: `templates/ux-engineer/`

| 模板                      | 说明         |
| ------------------------- | ------------ |
| ui-design-template.md     | UI设计文档   |
| interaction-template.md   | 交互设计规范 |
| design-system-template.md | 设计系统文档 |

## 协作关系

```mermaid
flowchart LR
    A[orchestrator-expert] -->|任务工单| B[ux-engineer]
    C[product-strategist] -->|PRD| B
    D[tech-architect] -->|技术方案| B
    B -->|设计稿| E[frontend-specialist]
    B -->|设计稿| F[mobile-specialist]
    B -->|状态更新| A
```
