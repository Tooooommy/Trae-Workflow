...
| 技能                    | 对应规则        |
| ----------------------- | --------------- |
| python-patterns         | Python 规则     |
| golang-patterns         | Go 规则         |
| rust-patterns           | Rust 规则       |
| ios-native-patterns     | Swift 规则      |
| android-native-patterns | Kotlin 规则     |
| coding-standards        | TypeScript 规则 |
