...
flowchart TD
    ...
    style Fast fill:#6bcf7f
    style Full fill:#4d96ff,color:#fff
    style Clarify fill:#f0f0f0
```
...
| 流程    | 关键词（匹配任意）                               |
| ------- | ------------------------------------------------ |
| 🔴 紧急 | 紧急、故障、生产、P0、线上、事故、崩溃、不可用   |
| 🟡 修复 | 修复、Bug、缺陷、问题、错误、异常、失效、不工作  |
| 🟢 快速 | 更新、修改、配置、调整、优化、变更、设置、参数   |
| 🔵 完整 | 新功能、开发、实现、构建、创建、添加、支持、集成 |
| 📝 澄清 | 其他不明确的需求                                 |
