---
name: tdd-workflow
description: 在编写新功能、修复错误或重构代码时使用此技能。强制执行测试驱动开发，确保单元测试、集成测试和端到端测试的覆盖率超过80%。**必须激活当**：用户要求编写新功能、修复 bug、重构代码、添加测试或遵循 TDD 流程。即使用户没有明确说"TDD"，当涉及测试驱动开发、测试覆盖率或质量保证时也应使用。
---
