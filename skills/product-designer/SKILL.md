...
4. **设计规范**
   ...
   - 编写 UI 设计文档: `docs/02-design/YYYY-MM-DD-<project-name>-ui-design.md`
   - 编写交互设计文档: `docs/02-design/YYYY-MM-DD-<project-name>-interaction.md`
   - 编写设计系统文档: `docs/02-design/YYYY-MM-DD-<project-name>-design-system.md`
...
- [ ] UI 设计文档符合 `YYYY-MM-DD-<project-name>-ui-design.md` 格式
- [ ] 交互设计文档符合 `YYYY-MM-DD-<project-name>-interaction.md` 格式
- [ ] 设计系统文档符合 `YYYY-MM-DD-<project-name>-design-system.md` 格式
