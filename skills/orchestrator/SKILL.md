...
```
需求与设计 → 开发与内建质量 → 集成与审计 → 发布与沉淀 → 复盘与改进
```

| 阶段              | 核心活动                                  | 参与专家                                                         | 关键产出                             |
| ----------------- | ----------------------------------------- | ---------------------------------------------------------------- | ------------------------------------ |
| 1. 需求与设计     | PRD输出、技术方案、原型设计，三方评审对齐 | product-strategist, tech-architect, ux-engineer                  | PRD、技术方案、设计稿                |
| 2. 开发与内建质量 | 编码、测试用例编写、安全编码规范          | dev-engineer, quality-engineer(提前介入), security-auditor(规范) | 源代码、单元测试、安全规范检查       |
| 3. 集成与审计     | CI/CD运行、自动化安全扫描、集成测试       | devops-engineer, security-auditor, quality-engineer              | 构建产物、安全扫描报告、集成测试报告 |
| 4. 发布与沉淀     | 部署、文档更新                            | devops-engineer, docs-engineer                                   | 线上服务、更新后的文档               |
| 5. 复盘与改进     | 复盘会议、改进项跟踪任务创建              | retro-facilitator                                                | 复盘报告、改进任务                   |
